    ...
    <div className="app">
      <div className="controls">
        <div className="control-group">
          <label htmlFor="font-family"><b>Font Family:</b></label>
        ...
        <div>
          <label htmlFor="italic"><b>Italic:</b></label>
          <Switch checked={isItalic} onChange={handleItalicChange} disabled={!isItalicAvailable}/>
        </div>
      </div>
